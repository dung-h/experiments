...
# Keep IBM access opt-in.  The original repository constructed a provider with
# a placeholder token at import time, which made every simulator/fake-backend
# experiment require network access and valid IBM credentials.  Real-device
# experiments can opt in by exporting QISKIT_TOKEN and setting
# QET_ENABLE_IBM=1.
QISKIT_TOKEN = os.getenv("QISKIT_TOKEN")
IBM_PROVIDER = None
if QISKIT_TOKEN and os.getenv("QET_ENABLE_IBM", "0") == "1":
